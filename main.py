...
def ShowStarInterface(screen, screensize):
    screen.fill((255, 123, 0))
    tfont = pygame.font.Font(config.FONTPATH, screensize[0] // 12)
    cfont = pygame.font.Font(config.FONTPATH, screensize[0] // 20)
    title = tfont.render(u'PRO ORANGE SKIING!!!', True, (0, 0, 0))
    content = cfont.render(u'PRESS ANY KEY TO SKI!!!', True, (255, 0, 0))
...
def main():
    ...
    pygame.display.set_caption('Pro-Skiing')
    ShowStarInterface(screen, config.SCREENSIZE)
    skier = SkierClass()
    obstacles0 = createObstacles(20, 29)
    obstacles1 = createObstacles(18, 19)
    obstaclesflag = 0
